...
<body>
    ...
    <script>
        ...
        function createFallingItem() {
                ...
                fallingItem.remove();
                    alert('Animation End Event Fired'); // Add this alert
                    showGameOver(); 
                });      
        ...
        function checkCollision(fallingItem) {
            ...
            // Calculate the distance between the bottom of the falling item and the top of the hamster
            const distance = hamsterRect.top - itemRect.bottom;     
            ...
            } else if (distance < 20) { // Adjust the threshold as needed
                // Falling item is close to the hamster, trigger game over logic
                showGameOver();
            }
        }
