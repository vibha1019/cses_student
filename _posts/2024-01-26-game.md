...
<body>
    ...
    <script>
        ...
        let isCarrotFalling = false; // Flag to check if a carrot is already falling
        let score = 0;
        ...
        function createFallingItem() {
            if (!isCarrotFalling) {
                isCarrotFalling = true; // Set the flag to true to indicate a carrot is falling
        ...
        setInterval(createFallingItem, 1000); // Create falling items every 3 seconds
        setInterval(() => {
