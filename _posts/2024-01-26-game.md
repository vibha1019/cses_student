...
<body>
    ...
    <script>
        ...
        function resetGame() {
            ...
            score = 0;
            scoreElement.textContent = `Score: ${score}`;
            fallingItemInterval = setInterval(createFallingItem, 3000); // Reset falling items interval
        }

        fallingItemInterval = setInterval(createFallingItem, 3000); // Create falling items every 3 seconds
    </script>
</body>
</html>
