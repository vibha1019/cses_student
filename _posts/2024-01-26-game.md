...
<body>
    ...
    <script>
        ...
        function checkCollision(fallingItem) {
            ...
            // Check if falling item reached the bottom (adjust the threshold as needed)
            if (itemRect.bottom <= 30) {
                // Falling item reached the specified coordinate, trigger game over logic
                showGameOver();
