    ...
    <script>
        ...
        function createFallingItem() {
            ...
            fallingItem.addEventListener('animationend', () => {
                ...
                if (!fallingItem.classList.contains('collision-detected')) {
                    fallingItem.remove();
                    showGameOver();
                } else {
                    fallingItem.classList.remove('collision-detected'); // Reset the class for the next falling item
                }
            });
        }
        function checkCollision(fallingItem) {
            ...
            if (
                ...
                fallingItem.classList.add('collision-detected'); // Add a class to mark the item as collided
            }
        }
        function showGameOver() {
            // Display game-over message only if there is no collision
