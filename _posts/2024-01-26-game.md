...
<body>
    ...
    <script>
        ...
        // Add this line to your existing code to call the gameOver function when the game starts
        // (this is just an example; you may want to trigger it under different conditions)
        // gameOver();
        setInterval(createFallingItem, 5000); // Create falling items every second
        setInterval(() => {
